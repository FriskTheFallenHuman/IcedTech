...
*/
// jmarshall
void idSysLocal::StartProcess( const char *exePath, bool doexit, const char *startDirectory) {
	...
	if( !CreateProcess( NULL, szPathOrig, NULL, NULL, FALSE, 0, NULL, startDirectory, &si, &pi ) ) {

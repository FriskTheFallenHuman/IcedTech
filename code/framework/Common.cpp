...
/*
=================
idCommonLocal::Compress
=================
*/
void idCommonLocal::Compress(byte *uncompressedMem, byte *compressedMem, int length, int &compressedLength) {
	// zlib struct
	z_stream defstream;
	...
	defstream.next_in = uncompressedMem; // input char array
	defstream.avail_out = length; // size of output
	defstream.next_out = compressedMem; // output char array
...
/*
=================
idCommonLocal::Decompress
=================
*/
void idCommonLocal::Decompress(byte *compressedMem, byte *uncompressedMem, int compressedMemLength, int outputMemLength) {
	z_stream infstream;
	infstream.zalloc = Z_NULL;
	infstream.zfree = Z_NULL;
	infstream.opaque = Z_NULL;
	// setup "b" as the input and "c" as the compressed output
	infstream.avail_in = compressedMemLength; // size of input
	infstream.next_in = compressedMem; // input char array
	infstream.avail_out = outputMemLength; // size of output
	infstream.next_out = uncompressedMem; // output char array
